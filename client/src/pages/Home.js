...
<section className="relative h-[80vh] w-full  overflow-hidden flex items-center justify-start">
  ...
  <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12  text-white">
    ...
    <p className="text-lg md:text-xl  max-w-lg leading-relaxed opacity-90">
      Discover our dirt-defying, hand-woven silk sarees crafted for the modern woman who loves timeless elegance.
    </p>
    <div className="flex gap-4 mb-4 mt-8">
      <button className="bg-white text-[#7b1e1e] px-8 py-4  font-bold uppercase tracking-widest hover:bg-[#7b1e1e] hover:text-white transition-all duration-300 shadow-xl">
      ...
      {/* 🏆 Best Sellers / Featured (Inspired by Image 3) */}
      {/* Products */}
...
<section className="max-w-7xl mx-auto px-6 py-20 bg-white">
  ...
  {loading ? (
    ...
    /* 📏 gap-x-12 for horizontal space, gap-y-20 for vertical space */
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-12 gap-y-20">
      ...
      {/* 📖 Heritage Section (Inspired by Image 4) */}
